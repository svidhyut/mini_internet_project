...
#80 Tier 2 ASes
tier1 = [[1,2],[21,22],[41,42],[61,62],[81,82],[101,102],[121,122],[141,142],[161,162],[181,182]]
...
ixp_central = 250
ixp_out = [251,252,253,254,255,256,257,258,259,260]
...
fd = open('external_links_config_80.txt', 'w')
fd_students = open('external_links_config_students_80.txt', 'w')
